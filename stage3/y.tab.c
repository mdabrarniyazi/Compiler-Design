...
{
  "$end", "error", "$undefined", "NUM", "ID", "READ", "WRITE", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "'='", "';'", "'('", "')'", "$accept",
...
{
      21,    -5,    19,    20,    36,    -3,   -10,     1,    33,     1,
     -10,   -10,   -10,   -10,   -10,     1,    22,    23,     9,    13,
       1,     1,     1,     1,   -10,    26,    27,   -10,     0,     0,
     -10,   -10,   -10,   -10
};
...
{
      18,     1,     2,     3,    13,    14,    19,     7,    11,    22,
      23,    28,    29,    30,    31,    15,    20,    21,    22,    23,
      20,    21,    22,    23,    26,     1,     2,     3,    27,    20,
      21,    22,    23,     8,     9,    24,    10,    17,    25,    32,
      33,     0,    12
};

static const yytype_int8 yycheck[] =
{
       9,     4,     5,     6,     3,     4,    15,    12,    11,     9,
      10,    20,    21,    22,    23,    14,     7,     8,     9,    10,
       7,     8,     9,    10,    15,     4,     5,     6,    15,     7,
       8,     9,    10,    14,    14,    13,     0,     4,    15,    13,
      13,    -1,     5
};
...
{
       0,     4,     5,     6,    17,    18,    19,    12,    14,    14,
       0,    11,    19,     3,     4,    14,    20,     4,    20,    20,
       7,     8,     9,    10,    13,    15,    15,    15,    20,    20,
      20,    20,    13,    13
};
